...
class ThemesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create theme" do
    assert_difference("Theme.count") do
      post themes_url, params: { theme: { deleted_at: @theme.deleted_at, post_id: @theme.post_id, topic_id: @theme.topic_id } }
    end
  ...
  test "should update theme" do
    patch theme_url(@theme), params: { theme: { deleted_at: @theme.deleted_at, post_id: @theme.post_id, topic_id: @theme.topic_id } }
