...
class FollowingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create following" do
    assert_difference("Following.count") do
      post followings_url, params: { following: { follower: @following.follower, following: @following.following } }
    end
  ...
  test "should update following" do
    patch following_url(@following), params: { following: { follower: @following.follower, following: @following.following } }
