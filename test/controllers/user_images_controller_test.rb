...
class UserImagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_image" do
    assert_difference("UserImage.count") do
      post user_images_url, params: { user_image: { img: @user_image.img, user_id: @user_image.user_id } }
    end
  ...
  test "should update user_image" do
    patch user_image_url(@user_image), params: { user_image: { img: @user_image.img, user_id: @user_image.user_id } }
